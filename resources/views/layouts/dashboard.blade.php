        ...
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                <div class="sidebar-brand">
                    <a class="navbar-brand" href="{{ url('/dashboard') }}">Copyright Cover</a>
...
{{--                                <i class="fa fa-tachometer-alt"></i>--}}
                        ...
                        <li  class="{{\Request::is('all-users') ? 'bgactivelink' : ''}}" style="border: 1px solid white;border-bottom: 0px">
                            <a class="{{\Request::is('all-users') ? 'coloractivelink' : ''}}" href="{{url('all-users')}}">
{{--                                <i class="fas fa-users"></i>--}}
                                <span>USERS</span>
                            </a>
                        </li>
                        <li  class="{{\Request::is('add-new-user') ? 'bgactivelink' : ''}}" style="border: 1px solid white;border-bottom: 0px">
                            <a class="{{\Request::is('add-new-user') ? 'coloractivelink' : ''}}" href="{{url('add-new-user')}}">
{{--                                <i class="fas fa-users"></i>--}}
